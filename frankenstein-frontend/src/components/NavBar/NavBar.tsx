...
function NavBar() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography as="a" variant="small" color="blue-gray" className="p-1 font-normal" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <a href="#" className="flex items-center">
          Pages
        </a>
      </Typography>
      <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <a href="#" className="flex items-center">
          Account
        </a>
      </Typography>
  ...
  return (
    <div className="-m-6 max-h-[768px] w-[calc(100%+24px)] overflow-hidden bg-gray-500 col-span-2">
      <Navbar
        className="sticky mt-4 top-5 z-10 h-max max-w-full rounded-none px-8 py-2 lg:px-8 lg:py-4"
